...
\providecommand{\algCtables}{\StrLeft{rs}{\ntables}}
\providecommand{\algBtables}{\StrLeft{NAL}{\ntables}}
...
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{cobyl_NAL_rs_slsqp_trust/}
\providecommand{\algorithmA}{NAL}
\providecommand{\algorithmB}{cobyla}
\providecommand{\algorithmC}{rs}
