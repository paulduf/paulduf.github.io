...
\providecommand{\algCtables}{\StrLeft{NEW+DGAM}{\ntables}}
\providecommand{\algBtables}{\StrLeft{OLD+NODGAM}{\ntables}}
\providecommand{\algAtables}{\StrLeft{OLD+DGAM}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{OLD+D_OLD+N_NEW+D/}
\providecommand{\algorithmA}{NEW+DGAM}
\providecommand{\algorithmB}{OLD+DGAM}
\providecommand{\algorithmC}{OLD+NODGAM}
